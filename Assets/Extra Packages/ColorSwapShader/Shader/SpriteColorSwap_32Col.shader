...
Shader "ColorSwap/SpriteColorSwap32Color"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 lerpResult17 = lerp( ( tex2DNode3 * tex2DNode3.a ) , ( AlphaFromTexture131 * Result32Samples129 ) , _OverallEffect);
...
/*ASEBEGIN
Version=17800
0;0;1920;1029;-832.6952;1142.471;1;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;130;1938.449,-548.2185;Inherit;False;129;Result32Samples;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=FA8253C158BF447DA816CE84B6B47B2563A7A517