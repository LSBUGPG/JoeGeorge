...
Shader "ColorSwap/SpriteColorSwap48Color"
{
	Properties
	{
		...
		[Header(Color Set 41)][Space(8)]_ColorDetect41("Color Detect 41", Color) = (0,0,0,0)
		_NewColor41("New Color 41", Color) = (1,1,1,1)
		_Range41("Range 41", Range( 0 , 1)) = 0.2
		_SoftFalloff41("Soft-Falloff41", Range( 0 , 1)) = 0.1
		[Header(Color Set 42)][Space(8)]_ColorDetect42("Color Detect 42", Color) = (0,0,0,0)
		_NewColor42("New Color 42", Color) = (1,1,1,1)
		_Range42("Range 42", Range( 0 , 1)) = 0.2
		_SoftFalloff42("Soft-Falloff42", Range( 0 , 1)) = 0.1
		[Header(Color Set 43)][Space(8)]_ColorDetect43("Color Detect 43", Color) = (0,0,0,0)
		_NewColor43("New Color 43", Color) = (1,1,1,1)
		_Range43("Range 43", Range( 0 , 1)) = 0.2
		_SoftFalloff43("Soft-Falloff43", Range( 0 , 1)) = 0.1
		[Header(Color Set 44)][Space(8)]_ColorDetect44("Color Detect 44", Color) = (0,0,0,0)
		_NewColor44("New Color 44", Color) = (1,1,1,1)
		_Range44("Range 44", Range( 0 , 1)) = 0.2
		_SoftFalloff44("Soft-Falloff44", Range( 0 , 1)) = 0.1
		[Header(Color Set 45)][Space(8)]_ColorDetect45("Color Detect 45", Color) = (0,0,0,0)
		_NewColor45("New Color 45", Color) = (1,1,1,1)
		_Range45("Range 45", Range( 0 , 1)) = 0.2
		_SoftFalloff45("Soft-Falloff45", Range( 0 , 1)) = 0.1
		[Header(Color Set 46)][Space(8)]_ColorDetect46("Color Detect 46", Color) = (0,0,0,0)
		_NewColor46("New Color 46", Color) = (1,1,1,1)
		_Range46("Range 46", Range( 0 , 1)) = 0.2
		_SoftFalloff46("Soft-Falloff46", Range( 0 , 1)) = 0.1
		[Header(Color Set 47)][Space(8)]_ColorDetect47("Color Detect 47", Color) = (0,0,0,0)
		_NewColor47("New Color 47", Color) = (1,1,1,1)
		_Range47("Range 47", Range( 0 , 1)) = 0.2
		_SoftFalloff47("Soft-Falloff47", Range( 0 , 1)) = 0.1
		[Header(Color Set 48)][Space(8)]_ColorDetect48("Color Detect 48", Color) = (0,0,0,0)
		_NewColor48("New Color 48", Color) = (1,1,1,1)
		_Range48("Range 48", Range( 0 , 1)) = 0.2
		_SoftFalloff48("Soft-Falloff48", Range( 0 , 1)) = 0.1
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			uniform float4 _NewColor41;
			uniform float4 _ColorDetect41;
			uniform float _Range41;
			uniform float _SoftFalloff41;
			uniform float4 _NewColor42;
			uniform float4 _ColorDetect42;
			uniform float _Range42;
			uniform float _SoftFalloff42;
			uniform float4 _NewColor43;
			uniform float4 _ColorDetect43;
			uniform float _Range43;
			uniform float _SoftFalloff43;
			uniform float4 _NewColor44;
			uniform float4 _ColorDetect44;
			uniform float _Range44;
			uniform float _SoftFalloff44;
			uniform float4 _NewColor45;
			uniform float4 _ColorDetect45;
			uniform float _Range45;
			uniform float _SoftFalloff45;
			uniform float4 _NewColor46;
			uniform float4 _ColorDetect46;
			uniform float _Range46;
			uniform float _SoftFalloff46;
			uniform float4 _NewColor47;
			uniform float4 _ColorDetect47;
			uniform float _Range47;
			uniform float _SoftFalloff47;
			uniform float4 _NewColor48;
			uniform float4 _ColorDetect48;
			uniform float _Range48;
			uniform float _SoftFalloff48;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 lerpResult326 = lerp( lerpResult317 , _NewColor41 , saturate( ( 1.0 - ( ( distance( _ColorDetect41.rgb , InputMask56.rgb ) - _Range41 ) / max( _SoftFalloff41 , 1E-05 ) ) ) ));
				float4 lerpResult332 = lerp( lerpResult326 , _NewColor42 , saturate( ( 1.0 - ( ( distance( _ColorDetect42.rgb , InputMask56.rgb ) - _Range42 ) / max( _SoftFalloff42 , 1E-05 ) ) ) ));
				float4 lerpResult335 = lerp( lerpResult332 , _NewColor43 , saturate( ( 1.0 - ( ( distance( _ColorDetect43.rgb , InputMask56.rgb ) - _Range43 ) / max( _SoftFalloff43 , 1E-05 ) ) ) ));
				float4 lerpResult344 = lerp( lerpResult335 , _NewColor44 , saturate( ( 1.0 - ( ( distance( _ColorDetect44.rgb , InputMask56.rgb ) - _Range44 ) / max( _SoftFalloff44 , 1E-05 ) ) ) ));
				float4 lerpResult351 = lerp( lerpResult344 , _NewColor45 , saturate( ( 1.0 - ( ( distance( _ColorDetect45.rgb , InputMask56.rgb ) - _Range45 ) / max( _SoftFalloff45 , 1E-05 ) ) ) ));
				float4 lerpResult359 = lerp( lerpResult351 , _NewColor46 , saturate( ( 1.0 - ( ( distance( _ColorDetect46.rgb , InputMask56.rgb ) - _Range46 ) / max( _SoftFalloff46 , 1E-05 ) ) ) ));
				float4 lerpResult362 = lerp( lerpResult359 , _NewColor47 , saturate( ( 1.0 - ( ( distance( _ColorDetect47.rgb , InputMask56.rgb ) - _Range47 ) / max( _SoftFalloff47 , 1E-05 ) ) ) ));
				float4 lerpResult369 = lerp( lerpResult362 , _NewColor48 , saturate( ( 1.0 - ( ( distance( _ColorDetect48.rgb , InputMask56.rgb ) - _Range48 ) / max( _SoftFalloff48 , 1E-05 ) ) ) ));
				float4 T_48Samples270 = lerpResult369;
				float4 lerpResult17 = lerp( ( tex2DNode3 * tex2DNode3.a ) , ( AlphaFromTexture131 * T_48Samples270 ) , _OverallEffect);
...
/*ASEBEGIN
Version=17800
0;0;1920;1029;10044.59;1709.453;13.95874;True;False
...
Node;AmplifyShaderEditor.ColorNode;320;4298.697,6515.498;Float;False;Property;_ColorDetect41;Color Detect 41;161;0;Create;True;0;0;False;2;Header(Color Set 41);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;323;4280.9,6706.745;Float;False;Property;_Range41;Range 41;163;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;321;4280.854,6805.156;Float;False;Property;_SoftFalloff41;Soft-Falloff41;164;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;322;4270.841,6397.626;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;325;4740.362,6404.697;Float;False;Property;_NewColor41;New Color 41;162;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;324;4733.009,6577.656;Inherit;False;Color Mask;-1;;45;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;327;4287.25,7573.596;Float;False;Property;_SoftFalloff42;Soft-Falloff42;168;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;333;4277.237,7166.066;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;329;4305.093,7283.938;Float;False;Property;_ColorDetect42;Color Detect 42;165;0;Create;True;0;0;False;2;Header(Color Set 42);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;328;4287.296,7475.186;Float;False;Property;_Range42;Range 42;167;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;330;4746.758,7173.137;Float;False;Property;_NewColor42;New Color 42;166;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;339;4327.155,8019.334;Float;False;Property;_ColorDetect43;Color Detect 43;169;0;Create;True;0;0;False;2;Header(Color Set 43);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;338;4309.312,8308.991;Float;False;Property;_SoftFalloff43;Soft-Falloff43;172;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;326;5399.384,6474.673;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;331;4739.405,7346.096;Inherit;False;Color Mask;-1;;46;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;336;4299.299,7901.462;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;337;4309.358,8210.582;Float;False;Property;_Range43;Range 43;171;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;347;4315.261,8994.813;Float;False;Property;_SoftFalloff44;Soft-Falloff44;176;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;332;5405.78,7243.113;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;346;4314.307,8897.403;Float;False;Property;_Range44;Range 44;175;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;334;4761.467,8081.492;Inherit;False;Color Mask;-1;;47;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;343;4305.248,8587.283;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;341;4333.104,8705.155;Float;False;Property;_ColorDetect44;Color Detect 44;173;0;Create;True;0;0;False;2;Header(Color Set 44);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;340;4768.82,7908.533;Float;False;Property;_NewColor43;New Color 43;170;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;353;4271.378,9599.604;Float;False;Property;_Range45;Range 45;179;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;342;4774.769,8594.354;Float;False;Property;_NewColor44;New Color 44;174;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;345;4767.416,8767.313;Inherit;False;Color Mask;-1;;48;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;335;5427.842,7978.509;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;348;4290.175,9407.356;Float;False;Property;_ColorDetect45;Color Detect 45;177;0;Create;True;0;0;False;2;Header(Color Set 45);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;350;4262.319,9289.485;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;354;4272.332,9697.015;Float;False;Property;_SoftFalloff45;Soft-Falloff45;180;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;352;4724.487,9469.515;Inherit;False;Color Mask;-1;;49;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;344;5433.791,8664.33;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;357;4303.544,10065.33;Float;False;Property;_ColorDetect46;Color Detect 46;181;0;Create;True;0;0;False;2;Header(Color Set 46);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;355;4285.701,10352.99;Float;False;Property;_SoftFalloff46;Soft-Falloff46;184;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;356;4284.747,10255.58;Float;False;Property;_Range46;Range 46;183;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;358;4275.688,9946.458;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;349;4731.84,9296.556;Float;False;Property;_NewColor45;New Color 45;178;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;368;4289.137,11028.76;Float;False;Property;_SoftFalloff47;Soft-Falloff47;188;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;351;5390.862,9366.532;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;366;4306.979,10741.1;Float;False;Property;_ColorDetect47;Color Detect 47;185;0;Create;True;0;0;False;2;Header(Color Set 47);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;367;4288.183,10931.35;Float;False;Property;_Range47;Range 47;187;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;361;4745.209,9953.528;Float;False;Property;_NewColor46;New Color 46;182;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;365;4279.124,10622.22;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;360;4737.856,10126.49;Inherit;False;Color Mask;-1;;50;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;359;5404.231,10023.5;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;375;4323.246,11739.7;Float;False;Property;_SoftFalloff48;Soft-Falloff48;192;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;374;4322.292,11642.29;Float;False;Property;_Range48;Range 48;191;0;Create;True;0;0;False;0;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;364;4748.645,10629.29;Float;False;Property;_NewColor47;New Color 47;186;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;373;4343.148,11452.04;Float;False;Property;_ColorDetect48;Color Detect 48;189;0;Create;True;0;0;False;2;Header(Color Set 48);Space(8);0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;363;4741.292,10802.26;Inherit;False;Color Mask;-1;;51;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;371;4313.232,11333.16;Inherit;False;56;InputMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;372;4782.753,11340.23;Float;False;Property;_NewColor48;New Color 48;190;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;362;5407.667,10699.27;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;370;4775.4,11513.2;Inherit;False;Color Mask;-1;;52;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;369;5441.775,11410.21;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;270;5678.776,11433.6;Inherit;False;T_48Samples;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;130;1408.457,-792.7515;Inherit;False;270;T_48Samples;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;2720.613,-1049.842;Float;False;True;-1;2;ASEMaterialInspector;0;4;ColorSwap/SpriteColorSwap48Color;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;True;2;False;-1;True;True;True;True;True;0;True;-9;True;True;0;True;-5;255;True;-8;255;True;-7;0;True;-4;0;True;-6;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;0;False;-1;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;0
...
WireConnection;324;3;320;0
WireConnection;324;4;323;0
WireConnection;324;5;321;0
...
WireConnection;334;4;337;0
WireConnection;334;5;338;0
WireConnection;345;1;343;0
WireConnection;345;3;341;0
WireConnection;345;4;346;0
WireConnection;345;5;347;0
WireConnection;335;0;332;0
WireConnection;335;1;340;0
WireConnection;335;2;334;0
WireConnection;352;1;350;0
WireConnection;352;3;348;0
...
WireConnection;360;4;356;0
WireConnection;360;5;355;0
...
WireConnection;363;4;367;0
WireConnection;363;5;368;0
WireConnection;362;0;359;0
WireConnection;362;1;364;0
WireConnection;362;2;363;0
WireConnection;370;1;371;0
WireConnection;370;3;373;0
WireConnection;370;4;374;0
WireConnection;370;5;375;0
WireConnection;369;0;362;0
WireConnection;369;1;372;0
WireConnection;369;2;370;0
WireConnection;131;0;3;4
WireConnection;270;0;369;0
...
ASEEND*/
//CHKSM=28D4B61DA88E1D1B7A6805F915F9BBEB47BE9BBB